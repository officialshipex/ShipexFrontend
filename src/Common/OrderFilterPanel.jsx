        ...
        <div className="fixed inset-0 z-[100] flex justify-end">
            ...
            <div className="relative w-full max-w-[340px] bg-white h-full shadow-2xl flex flex-col animate-slide-in-right">
                ...
                <div className="flex items-center justify-between px-4 py-2 border-b">
                    <h2 className="text-[16px] font-bold text-brand-secondary tracking-tight">Filters</h2>
                    ...
                    <div className="space-y-1 relative" ref={searchRef}>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`${fieldStyle} bg-white border text-gray-700 placeholder:text-gray-400 focus:outline-none focus:border-brand-primary`}
                    ...
                    <div className="space-y-1" ref={paymentRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showPaymentDropdown ? "border-brand-primary" : "border-gray-200"} bg-white`}
                            >
                    ...
                    <div className="space-y-1" ref={pickupRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showPickupDropdown ? "border-brand-primary" : "border-gray-200"} bg-white`}
                            >
                                ...
                                <div className="absolute top-[105%] left-0 w-full bg-white border border-gray-100 rounded-lg shadow-xl z-10 py-1 animate-popup-in max-h-60 overflow-y-auto">
                                    <div className="sticky top-0 bg-white px-2 py-1 border-b">
                                        <input
                                            ...
                                            className="w-full px-2 py-1 text-[11px] border rounded focus:outline-none focus:border-brand-primary"
                                            value={pickupSearch}
                        ...
                        <div className="space-y-1" ref={courierRef}>
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`${fieldStyle} ${showCourierDropdown ? "border-brand-primary" : "border-gray-200"} bg-white`}
                                >
                ...
                <div className="p-4 border-t bg-white flex gap-3">
                    ...
                    <button
                        onClick={handleApply}
                        className="flex-1 py-2 bg-brand-primary text-white rounded-lg text-[12px] font-[600] hover:bg-opacity-90 transition-all shadow-sm active:scale-[0.98]"
                    >
                        Apply Filters
                    </button>
                </div>
