                        ...
                        orders.map((order, index) => (
                            <div key={index} className="bg-white rounded-lg border border-gray-300 overflow-hidden text-[12px] relative">
                                ...
                                <div className="flex justify-between items-center px-3 py-2 bg-red-50 text-[10px]">
                                    <div className="text-red-700">Charged Weight: {order.chargedWeight?.applicableWeight} Kg</div>
                                ...
                                <div className="flex items-center justify-between px-3 py-2 bg-white">
                                    ...
                                    <div className="bg-green-100 text-green-700 text-[10px] px-2 py-1 rounded-lg">{order.clientStatus}</div>
                                </div>
