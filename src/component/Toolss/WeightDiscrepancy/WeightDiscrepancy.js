  ...
  return (
    <div className="sm:px-2 flex flex-col">
      ...
      <div className="w-full">
        ...
        <div className="md:hidden bg-white border border-brand-primary rounded-lg px-3 py-2 text-[10px] text-gray-700 space-y-2">
          {[
        ...
        <div className="hidden md:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
          {[
            ...
            >
              <div className="p-2 bg-brand-primary rounded-full font-[600] flex items-center justify-center">
                {item.icon}
              </div>
              <div>
