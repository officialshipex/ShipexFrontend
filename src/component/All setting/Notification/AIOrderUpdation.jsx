...
const Toggle = ({ enabled, onChange, disabled = false, id }) => (
  <button
    ...
    className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-1
...
const FeatureCard = ({ icon, title, description, enabled, onToggle, adminEnabled, stats, activeLabel }) => (
  <div className={`relative bg-white border rounded-lg px-3 py-2 transition-all duration-300
    ${enabled && adminEnabled ? "border-brand-primary" : "border-gray-200"}`}>
    {/* Header */}
    <div className="flex items-start justify-between gap-2">
      ...
      <div className="flex flex-col items-end gap-1 flex-shrink-0">
        ...
        {enabled && adminEnabled && (
          <span className="text-[10px] text-brand-primary font-[600]">{activeLabel}</span>
        )}
      </div>
    </div>
      ...
      <div className="flex items-center justify-between bg-white border border-gray-200 rounded-lg px-3 py-2 shadow-sm">
        ...
        {/* <div className="flex items-center gap-2">
          <div className="text-right">
            ...
            <p className="text-[14px] font-[700] text-brand-primary">{creditBalance}</p>
          </div>
          <button
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="text-[11px] border border-gray-200 rounded-lg px-2 py-1.5 focus:outline-none focus:ring-1 focus:ring-brand-primary bg-white"
            >
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full">
            <thead>
              <tr className="bg-brand-primary text-white text-[11px] font-[600]">
                ...
                logs.map((log) => {
                  ...
                  return (
                    <tr key={log._id} className="border-b border-gray-100 hover:bg-gray-50 text-[11px]">
                      ...
                      {/* Order / AWB */}
                      <td className="py-2 px-3 whitespace-nowrap">
                        <p className="text-brand-primary font-[600]">#{log.orderDisplayId || "—"}</p>
                      ...
                      <td className="py-2 px-3 whitespace-nowrap">
                        {log.recordingUrl ? (
                          <a
                            ...
                            className="inline-flex items-center gap-1 text-[10px] text-brand-primary font-[600] hover:underline"
                          >
