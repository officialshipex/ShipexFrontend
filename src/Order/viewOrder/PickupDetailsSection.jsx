        ...
        <div className="group">
            ...
            <div className="flex items-center gap-2">
                ...
                {value && (
                    ...
                    >
                        <div className="relative flex items-center justify-center w-5 h-5 text-gray-500 hover:text-brand-primary">
                    ...
                    <div className="sm:col-span-2 group">
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            {order.pickupAddress?.address && (
                                ...
                                >
                                    <div className="relative flex items-center justify-center text-gray-500 w-4 h-4 hover:text-brand-primary">
                    ...
                    {mobileOpen && (
                        <div className="mt-2 pl-1 border-l-2 border-green-200 animate-popup-in">
                            ...
                            <button
                                ...
                                className="mt-2 flex items-center gap-2 text-brand-primary text-[12px] font-[600]"
                            >
