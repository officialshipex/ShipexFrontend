...
const PackageDetails = ({
  ...
  return (
    <div className="border mt-2 border-brand-primary rounded-lg p-4 bg-white">

      {/* HEADER */}
      <h2 className="text-[14px] font-[600] flex items-center gap-2 text-gray-700 mb-2">
        <span className="bg-brand-primary text-white rounded-lg p-2">
      ...
      {orderType === "B2C" && (
        <>
            ...
            <div className="w-[160px] font-[600] text-[12px] text-gray-700 flex flex-col">
              ...
              <div className="flex items-center border rounded-lg w-full">
                <input
                  ...
                  placeholder="0.00"
                />
                <span className="w-12 h-8 flex justify-center items-center text-[12px] text-white rounded-r-lg bg-brand-primary">
                  kg
                </span>
              </div>
            </div>
              ...
              {["length", "width", "height"].map((dim) => (
                <div key={dim} className="w-full md:w-[160px] flex flex-col">
                  ...
                  <div className="flex items-center border rounded-lg w-full">
                    ...
                    />
                    <span className="w-12 h-8 flex font-[600] justify-center items-center text-[12px] text-white rounded-r-lg bg-brand-primary">
                      cm
                    </span>
                  </div>
                </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-2">
            <div className="bg-brand-secondary/15 border border-brand-secondary/30 rounded-lg p-3 w-full sm:w-2/4">
              <div className="flex sm:flex-col flex-row justify-between">
                <h3 className="text-[12px] font-[600] text-gray-700">
                  Applicable Weight
                </h3>
                <p className="text-[12px] font-[600] text-brand-secondary">
                  {applicableWeight} Kg
                </p>
              </div>
              <p className="text-[12px] text-gray-500 mt-2">
            ...
            <div className="bg-brand-secondary/15 border border-brand-secondary/30 rounded-lg p-3 w-full sm:w-1/2 flex justify-between items-center">
              <h3 className="text-[12px] font-[600] text-gray-700">Volumetric Weight</h3>
              <p className="text-[12px] font-[600] text-brand-secondary">{volumetricWeight} Kg</p>
            </div>
          </div>

          <hr className="my-4" />

          <div className="bg-brand-secondary/15 border border-brand-secondary/30 px-3 py-2 rounded-lg mb-4 flex justify-between items-center">
            <p className="text-[12px] font-[600] text-gray-700">Total Order Value</p>
            <p className="text-[12px] font-[600] text-brand-secondary">₹{totalPrice}</p>
          </div>
        </>
      )}
      ...
      {orderType === "B2B" && (
        <>
          {B2BPackageDetails.map((pkg, index) => (
            <div
              key={pkg.id}
              className="border border-dashed border-brand-primary rounded-lg p-4 my-4 relative bg-white"
            >
              {/* Badge */}
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-brand-primary text-white w-8 h-8 flex justify-center items-center rounded-full text-[12px] font-[600] shadow">
                {index + 1}
              </div>
              ...
              <div className="grid grid-cols-2 text-[12px] text-gray-700 md:grid-cols-5 font-[600] gap-2 mt-4">
                <div>
                  ...
                  <input
                    ...
                    className="border rounded-lg focus:outline-brand-primary px-3 py-2 text-[12px] w-full"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="border rounded-lg px-3 focus:outline-brand-primary py-2 text-[12px] w-full"
                    placeholder="Weight"
                  />
                </div>
                ...
                {["length", "width", "height"].map((dim) => (
                  <div key={dim}>
                    ...
                    <input
                      ...
                      className="border rounded-lg focus:outline-brand-primary px-3 py-2 font-[600] text-[12px] w-full"
                      placeholder={dim}
                    />
                  </div>
                ))}
          ...
          <button
            ...
            className="flex items-center justify-center w-8 h-8 bg-brand-primary text-white rounded-full mx-auto text-[12px]"
          >
            +
          </button>
          ...
          <div className="flex flex-col sm:flex-row gap-2 mt-4">
            <div className="bg-brand-secondary/15 border border-brand-secondary/30 p-4 rounded-lg w-full sm:w-2/4">
              <h3 className="text-[12px] font-[600] text-gray-700">Applicable Weight</h3>
              <p className="text-[12px] font-[600] text-brand-secondary">{applicableWeightB2B.toFixed(2)} Kg</p>
            </div>

            <div className="bg-brand-secondary/15 border border-brand-secondary/30 p-4 rounded-lg w-full sm:w-1/2 flex justify-between items-center">
              <h3 className="text-[12px] font-[600] text-gray-700">Volumetric Weight</h3>
              <p className="text-[12px] font-[600] text-brand-secondary">{totalVolumetricWeightB2B.toFixed(2)} Kg</p>
            </div>
          </div>

          <hr className="my-4" />

          <div className="bg-brand-secondary/15 border border-brand-secondary/30 px-4 py-2 rounded-lg mb-4 flex justify-between items-center">
            <p className="text-[12px] font-[600] text-gray-700">Total Order Value</p>
            <p className="text-[12px] font-[600] text-brand-secondary">₹{totalPrice}</p>
          </div>
        </>
