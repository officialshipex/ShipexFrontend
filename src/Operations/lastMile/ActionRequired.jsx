...
const ActionRequired = (filterData, { isSidebarAdmin }) => {
                ...
                <div className="flex items-center justify-between w-full gap-3 mb-1">
                  <div className="flex items-center">
                    <input
                      ...
                      checked={selectedOrders.includes(order._id)}
                      onChange={() => handleCheckboxChange(order._id)}
                      className="cursor-pointer accent-[#0CBB7D] mr-1 w-3 h-3"
                    />
                    <span className="flex">
                  ...
                  <div className="relative sm:hidden flex justify-end">
                    {((order.provider === "DTDC" || order.provider === "Dtdc") ? order.reattempt : true) && (
                      <>
                        <button
                          className="px-2 py-1 bg-[#0CBB7D] text-[10px] font-[600] text-white rounded-lg"
                          onClick={() => openModal(order)}
                        >
                          Take Action
                        </button>
