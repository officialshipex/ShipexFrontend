...
const ActionRequested = (filterData) => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      console.log("reda", response.data)
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-2 sm:my-2">
          ...
          <div className="flex gap-2 flex-col md:flex-row md:hidden w-full">
            <div className="flex items-center justify-between gap-2 relative">
              ...
              {/* FaFilter Button */}
              <button
                className="px-3 flex border-2 border-gray-100 items-center justify-center text-white bg-[#0CBB7D] h-8 rounded-lg transition text-[12px] font-[600]"
          ...
          <tbody>
            {loading1 ? (
              ...
              orders.map((order, index) => (
                <tr
                  key={index}
                  className="border-t hover:bg-gray-50 transition-all text-xs md:text-[12px] lg:text-[12px]"
                >
              ...
              <tr>
                <td colSpan="11" className="text-gray-500 text-center py-6">
