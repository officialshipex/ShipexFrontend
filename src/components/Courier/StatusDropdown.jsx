  ...
  return (
    <div className="relative w-full flex flex-col gap-1" ref={dropdownRef}>
      ...
      <div
        ...
        className={`bg-white cursor-pointer px-2 h-9 border rounded-lg flex justify-between items-center transition-all ${isOpen ? "border-brand-primary ring-1 ring-brand-primary/20" : "border-gray-200"}`}
      >
