...
const BoxdLogisticsAdd = ({ onCourierSaved, canAction }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await axios.post(
                `${REACT_APP_BACKEND_URL}/BoxdLogistics/addCourier`,
                newCourier
            );

            Notification("Boxd Logistics courier added successfully", "success");
            setCourierName("");
            setCodDays("");
            setEmail("");
            setPassword("");
            ...
            console.error("Error adding BoxdLogistics courier:", error);
            Notification(
        ...
        <div className="w-full animate-fadeIn">
            <div className="grid font-[600] grid-cols-2 xl:flex xl:flex-row items-start xl:items-end gap-2 w-full">
                ...
                <div className="w-full xl:w-48 flex flex-col gap-1">
                    ...
                    <input
                        type="text"
                        placeholder="BoxdLogistics Name"
...
export default BoxdLogisticsAdd;
