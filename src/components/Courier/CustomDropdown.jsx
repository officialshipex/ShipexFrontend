          ...
          {options.length > 0 ? (
            options.map((option) => (
              <li
                ...
                className={`px-3 py-2 text-[11px] font-[500] transition-colors cursor-pointer ${selected === option.value ? "bg-green-50 text-brand-primary" : "text-gray-600 hover:bg-gray-50"}`}
              >
                {option.label}
              </li>
            ))
