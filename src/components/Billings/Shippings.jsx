  ...
  return (
    ...
    ">
          <table className="w-full border-collapse">
            {/* Table Head */}
            <thead className="sticky top-0 z-20 bg-brand-primary">
              <tr className="text-white bg-brand-primary text-[12px] font-[600]">
                <th className="py-2 px-3 text-left bg-brand-primary shadow-[0_1px_0_0_var(--brand-primary,#0CBB7D)]">
                  ...
                  >
                    ...
                    <td className="py-2 px-3 whitespace-nowrap">
                      <div className="relative flex items-center gap-1 group max-w-fit">
                        <span
                          className="text-brand-primary cursor-pointer font-medium hover:underline"
                    ...
                    <td className="py-2 px-3 whitespace-nowrap text-center">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        {order.totalFreightCharges && (
                          ...
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-brand-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><circle cx="12" cy="12" r="10" /><path d="M12 8v4m0 4h.01" strokeWidth="2" strokeLinecap="round" /></svg>
                          </div>
                        )}
                      </div>
                    </td>
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="font-[600] text-[10px]">Order Id :<span className="text-brand-primary">{row.orderId}</span></span>
