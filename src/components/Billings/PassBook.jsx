                  ...
                  <tr key={index} className="border-b border-gray-200 hover:bg-gray-50 text-gray-700 transition-colors">
                    ...
                    <td className="py-2 px-3">
                      <div className="flex items-center gap-1 group">
                        <Link to={`/dashboard/order/neworder/updateOrder/${row.orderId}`} className="text-brand-primary hover:underline block font-medium">
                          {row.orderId}
                        </Link>
                    ...
                    <td className="py-2 px-3">
                      <div className="flex items-center gap-1 group">
                        <p className="text-brand-primary cursor-pointer hover:underline font-medium" onClick={() => handleTrackingByAwb(row.awb_number)}>
                          {row.awb_number}
                        </p>
                    ...
                    <td className="py-2 px-3">
                      <div className="flex items-center gap-1 justify-start">
                        <span className={`${row.category === "debit" ? "text-red-500" : "text-brand-primary"} font-medium`}>
                ...
                <div className="grid grid-cols-2 gap-y-2">
                  ...
                  <div className="text-right text-[10px]">
                    ...
                    <div className="flex items-center justify-end gap-1">
                      <p className="text-brand-primary font-[600] truncate hover:underline" onClick={() => handleTrackingByAwb(row.awb_number)}>
                        {row.awb_number || "N/A"}
                      </p>
                      {row.awb_number && (
                  ...
                  <div className="border-t my-1 border-gray-50 col-span-2 flex justify-between items-center">
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        <p className={`text-[10px] font-bold ${row.category === "debit" ? "text-red-500" : "text-brand-primary"}`}>
                          {row.category === "debit" ? "-" : "+"} ₹{Number(row.amount).toFixed(2)}
                        </p>
                        {row.category === "debit" && (
                          <button
                            ...
                            className="text-brand-primary p-2 -m-2 flex items-center justify-center cursor-pointer"
                          >
