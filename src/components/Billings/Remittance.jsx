                        ...
                        {row.utr && (
                          <button onClick={() => handleCopy(row.utr, row.remittanceId + '_utr')}>
                            {copiedId === row.remittanceId + '_utr' ? (
                              <FiCheck className="text-brand-primary w-3 h-3" />
                            ) : (
                              <FiCopy className="text-gray-400 opacity-0 group-hover:opacity-100 w-3 h-3 transition-opacity" />
                            )}
                          </button>
              ...
              <div key={row.remittanceId} className={`bg-white rounded-lg shadow-sm animate-popup-in border border-gray-200 px-3 py-2 relative ${detailsPopupId === row.remittanceId ? 'z-50' : 'z-10'}`}>
                <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex flex-col">
                          ...
                          <div className="flex items-center gap-1 group">
                            ...
                            <span className="font-[600] text-brand-primary text-[10px] hover:underline cursor-pointer" onClick={() => openRemittanceDetails(row.remittanceId)}>
                              {row.remittanceId}
                            </span>
                  ...
                  <div className="text-right flex flex-col items-end">
                    <div className="flex flex-col items-end">
                      ...
                      <p className="font-bold text-brand-primary text-[10px] tracking-tight">₹{(Number(row.codAvailable) || 0).toFixed(2)}</p>
                      <p
                        className="text-[9px] text-brand-primary font-bold border-b border-dashed border-brand-primary cursor-pointer hover:opacity-80 mt-0.5"
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px] mb-2 p-1.5 bg-green-50 rounded-lg">
                  <div>
                    ...
                    <div className="flex items-center gap-1 group">
                      <p className="font-bold text-brand-primary">{row.utr || "N/N"}</p>
                      {row.utr && (
