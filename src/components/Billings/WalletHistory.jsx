              ...
              {loading ? (
                ...
                transactions.map((row) => (
                  <tr key={row._id} className="hover:bg-gray-50 text-[12px] transition-colors border-b border-gray-200 text-gray-600">
                    ...
                    <td className="px-3 py-2">
                      <span className={`px-2 py-0.5 rounded text-[10px] ${row.status === "success" ? "bg-green-50 text-brand-primary" : "bg-red-50 text-red-500"}`}>
                        {row.status}
                      </span>
                    </td>
                    <td className="px-3 py-2">
              ...
              <div key={row._id} className="bg-white rounded-xl shadow-sm p-3 border border-gray-100 text-[10px] animate-popup-in">
                <div className="flex justify-between mb-2 items-start">
                  ...
                  <div className="text-right">
                    ...
                    <span className={`px-2 py-0.5 rounded text-[10px] inline-block mt-1 ${row.status === "success" ? "bg-green-50 text-brand-primary" : "bg-red-50 text-red-500"}`}>
                      {row.status}
                    </span>
                  </div>
                </div>
