    ...
    return (
        <div className='sm:px-2 p-1'>
            <div className="flex items-center justify-between mb-2">
                ...
                <button
                    className="text-white bg-brand-primary hover:bg-green-500 px-3 py-2 rounded-lg shadow text-[10px] sm:text-[12px] font-[600]"
                            ...
                            return (
                                <tr key={role._id || index} className="border hover:bg-gray-50 text-gray-500 text-[12px] border-gray-300">
                                    ...
                                    <td className="px-3 py-2 text-center">
                                        <button
                                            title="Edit"
                                            className="text-white px-2 py-1 font-[600] rounded-lg text-[10px] sm:text-[12px] hover:text-green-500 bg-brand-primary transition-colors"
