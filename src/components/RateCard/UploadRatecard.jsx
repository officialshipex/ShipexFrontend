            ...
            <div className="bg-white p-4 rounded-lg shadow-sm w-[500px] relative animate-popup-in border border-gray-100">
                ...
                <div className="flex justify-end items-center mt-8 gap-3">
                    <button
                        ...
                        className="py-2 px-3 bg-brand-primary text-white rounded-lg text-[10px] sm:text-[12px] font-bold hover:opacity-90 transition-all flex items-center justify-center gap-2"
                    >
                        Confirm & Upload
                    </button>
                </div>
