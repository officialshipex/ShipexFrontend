        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex justify-center items-center">
            <div className="bg-white w-[95%] md:w-[800px] rounded-lg p-4 max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-2 mt-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="border px-3 py-2 text-[12px] font-[600] rounded-lg w-full focus:outline-[#0192ED]"
                                    placeholder="Boxes"
                                />
                            </div>
                ...
                <div className="flex justify-center my-4">
                    <button
                        onClick={addPackage}
                        className="w-8 h-8 rounded-full bg-[#0192ED] flex justify-center items-center text-white text-[12px] font-[600]"
                    >
                        <span>+</span>
                    </button>
                </div>
                ...
                <div className="flex justify-end gap-2 mt-2">
                    ...
                    <button
                        ...
                        className="px-3 py-2 bg-[#0192ED] font-[600] hover:opacity-90 transition text-white rounded-lg text-[12px]"
                    >
                        Save
                    </button>
                </div>
