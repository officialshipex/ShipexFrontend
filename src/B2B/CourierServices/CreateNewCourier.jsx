      ...
      try {
        ...
        switch (value) {
          ...
          case "Xpressbees":
            ...
            break;
          case "Shiprocket":
            console.log("Fetching Shiprocket services");
            response = await axios.get(`${REACT_APP_BACKEND_URL}/b2b/couriers/getShiprocketCourierServices`);
            console.log("Shiprocket Services Response:", response.data);
            services = response.data.data.map((item) => item.service);
            break;
          case "Dtdc":
      ...
      <div className="max-w-full mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex sm:flex-row flex-col gap-2">
          ...
          <div className="flex gap-2 w-full">
            ...
            <div className="w-full sm:w-auto">
              <label className="block text-[10px] sm:text-[12px] text-gray-500">Weight</label>
              <input
                type="text"
                name="weight"
