...
const Zipypost = ({ onCourierSaved, canAction }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${REACT_APP_BACKEND_URL}/b2b/ZipyPost/authorize`, newCourier);
            Notification('B2B ZipyPost courier added successfully', "success");
            ...
            console.error("B2B ZipyPost Save Error:", error);
