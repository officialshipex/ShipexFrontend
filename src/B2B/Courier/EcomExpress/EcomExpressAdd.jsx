...
const EcomExpressAdd = ({ onCourierSaved, canAction }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${REACT_APP_BACKEND_URL}/b2b/EcomExpress/getAuthToken`, newCourier);
      Notification(response.data.message || "B2B EcomExpress courier added successfully", "success");
      ...
      console.error("B2B EcomExpress Save Error:", error);
