...
const Shiprocket = ({ onCourierSaved, canAction }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${REACT_APP_BACKEND_URL}/b2b/shiprocket/getToken`,
        newCourier
      );
      ...
      console.error("B2B Shiprocket Save Error:", error);
  ...
  return (
    <div className="w-full animate-fadeIn">
      <div className="grid font-[600] grid-cols-2 xl:flex xl:flex-row items-start xl:items-end gap-2 w-full">
        ...
        <div className="w-full xl:w-48 flex flex-col gap-1">
          <label className="text-[10px] sm:text-[12px] font-[600] text-gray-700 tracking-tight">Email/User</label>
          <input
            type="text"
