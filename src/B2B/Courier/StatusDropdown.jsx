        ...
        <ul className="absolute z-[70] top-full left-0 w-full bg-white border border-gray-100 mt-1 rounded-lg shadow-lg max-h-56 overflow-y-auto animate-popup-in py-1">
          {options.map((option) => (
            <li
              ...
              className={`px-3 py-2 text-[10px] sm:text-[12px] transition-colors cursor-pointer ${Status === option ? "bg-green-50 text-brand-primary" : "text-gray-600 hover:bg-gray-50"}`}
            >
              {option}
            </li>
          ))}
