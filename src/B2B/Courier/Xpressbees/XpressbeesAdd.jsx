...
const XpressbeesAdd = ({ onCourierSaved, canAction }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${REACT_APP_BACKEND_URL}/b2b/Xpressbees/getAuthToken`,
        newCourier
      );

      Notification(response.data.message || "B2B Xpressbees courier added successfully", "success");
      setCourierName("");
      setCodDays("");
      setEmail("");
      setPassword("");
      ...
      console.error("B2B Xpressbees Save Error:", error);
