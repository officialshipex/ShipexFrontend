  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${REACT_APP_BACKEND_URL}/b2b/ShreeMaruti/getAuthToken`,
        newCourier
      );

      Notification(response.data.message || "B2B Shree Maruti courier added successfully", "success");
      setCourierName("");
      setCodDays("");
      setUsername("");
      setPassword("");
      ...
      console.error("B2B Shree Maruti Save Error:", error);
