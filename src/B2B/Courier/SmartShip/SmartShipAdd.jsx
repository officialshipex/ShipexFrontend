...
const Smartship = ({ onCourierSaved, canAction }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${REACT_APP_BACKEND_URL}/b2b/SmartShip/authorize`, newCourier);
      Notification("B2B Smartship courier added successfully", "success");
      ...
      console.error("B2B Smartship Save Error:", error);
