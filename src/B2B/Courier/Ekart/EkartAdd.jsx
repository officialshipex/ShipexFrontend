...
const Ekart = ({ onCourierSaved, canAction }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${REACT_APP_BACKEND_URL}/b2b/Ekart/authorize`, newCourier);
      Notification("B2B Ekart courier added successfully", "success");
      ...
      console.error("B2B Ekart Save Error:", error);
